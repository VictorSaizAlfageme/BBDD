...
CREATE TABLE HJOB(
EMP_NO    NUMBER(4) CONSTRAINT HJOB_EMPNO_FK REFERENCES EMPLE
						  ON DELETE CASCADE,
OFICIO		VARCHAR2(15) ,
FECHA_INICIO	DATE,
FECHA_FIN		DATE,
...
*Cause:    
*Action: Quitar la coma despues de number(4), agrandar el valor de oficio de 3
a lo que sea necesario para poder introducir los datos necesarios
*/

INSERT INTO HJOB VALUES(7654,'T1',TO_DATE('10/01/79','DD/MM/YY'),TO_DATE('15/06/87','DD/MM/YY'),10);
INSERT INTO HJOB VALUES(7654,'T2',TO_DATE('18/01/88','DD/MM/YY'),TO_DATE('15/06/95','DD/MM/YY'),20);
INSERT INTO HJOB VALUES(7654,'T1',TO_DATE('17/06/96','DD/MM/YY'),TO_DATE('21/07/98','DD/MM/YY'),10);
INSERT INTO HJOB VALUES(7369,'AUXILIAR',TO_DATE('10/01/1999','DD/MM/YYYY'),TO_DATE('15/06/2000','DD/MM/YYYY'),10);
INSERT INTO HJOB VALUES(7369,'COMERCIAL',TO_DATE('10/01/02','DD/MM/YY'),TO_DATE('20/03/05','DD/MM/YY'),10);
INSERT INTO HJOB VALUES(7876,'AUXILIAR',TO_DATE('10/01/08','DD/MM/YY'),TO_DATE('15/06/10','DD/MM/YY'),30);
INSERT INTO HJOB VALUES(7876,'COMERCIAL',TO_DATE('10/01/05','DD/MM/YY'),TO_DATE('15/06/07','DD/MM/YY'),20);
INSERT INTO HJOB VALUES(7844,'AUXILIAR',TO_DATE('10/01/11','DD/MM/YY'),TO_DATE('28/01/11','DD/MM/YY'),10);
